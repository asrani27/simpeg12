...
<div x-data="{ 
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-6">
        ...
        <div class="bg-gradient-to-r from-purple-600 to-blue-600 px-6 py-4 flex items-center justify-between">
            <h3 class="text-lg font-semibold text-white">Data Persyaratan usul_pns</h3>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-4 text-sm">
                                <div class="flex space-x-2">
                                    ...
                                    <a href="/usul_pns/persyaratan/delete/{{$item->id}}"
    ...
    <!-- Modal Tambah -->
    <div x-show="openTambahModal" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
        ...
        <div class="flex items-center justify-center min-h-screen p-4 text-center sm:p-0">
            <div x-show="openTambahModal" x-transition:enter="ease-out duration-300"
                ...
                <!-- Modal Content -->
                <form method="post" action="/usul_pns/persyaratan/create" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="px-6 py-4">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="layanan_id" name="layanan_id"
                                class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors">
                                @foreach (layanan('usul_pns') as $item)
    ...
    <div x-show="openEditModal" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
        ...
        <div class="flex items-center justify-center min-h-screen p-4 text-center sm:p-0">
            <div x-show="openEditModal" x-transition:enter="ease-out duration-300"
                ...
                <!-- Modal Content -->
                <form method="post" action="/usul_pns/persyaratan/edit" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="px-6 py-4">
                        ...
                        <div class="mb-4">
                            <label for="edit_layanan_id" class="block text-sm font-medium text-gray-700 mb-2">Jenis
                                Kenaikan
                                Pangkat</label>
