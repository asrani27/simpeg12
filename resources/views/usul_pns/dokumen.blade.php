...
@section('title', 'Dokumen usul_pns')
    ...
    <div class="lg:col-span-3">
        <div class="bg-white border-2 border-indigo-500 rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-purple-600 to-blue-600 px-4 py-2 flex justify-between items-center">
                ...
                <a href="{{ route('login') }}/usul_pns/dokumen/{{ $id }}/zip"
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-3 py-2 border border-gray-300">
                                    @if ($dokumen)
                                    <a target="_blank"
                                        href="/storage/usul_pns/{{ $data->pegawai->nip }}/pengajuan{{ $id }}/{{ $dokumen->file }}"
                                ...
                                <td class="px-3 py-2 border border-gray-300 text-center">
                                    ...
                                    <div class="flex items-center justify-center gap-1">
                                        <a href="/usul_pns/dokumen/{{ $id }}/berkas-ok/{{ $dokumen->id }}"
...
<div id="modal-perbaiki" class="fixed inset-0 z-50 hidden overflow-y-auto" aria-labelledby="modal-title" role="dialog"
    ...
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
            ...
            <form method="post" action="/usul_pns/dokumen/{{ $id }}/perbaikidokumen" enctype="multipart/form-data">
                @csrf
