...
<div class="bg-white rounded-xl shadow-lg overflow-hidden mb-6">
    ...
    <div class="bg-gradient-to-r from-purple-600 to-blue-600 px-6 py-4 flex items-center justify-between">
        <h3 class="text-lg font-semibold text-white">Data Jenis</h3>
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-4 py-4 text-sm">
                            <div class="flex space-x-2">
                                ...
                                <a href="/usul_pns/jenis_usul_pns/delete/{{$item->id}}"
...
<div id="modalTambah" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
    ...
    <div class="flex items-center justify-center min-h-screen p-4 text-center sm:p-0">
        <div class="relative bg-white rounded-xl shadow-xl transform transition-all sm:max-w-md w-full">
            ...
            <!-- Modal Content -->
            <form method="post" action="/usul_pns/jenis_usul_pns/create" enctype="multipart/form-data">
                @csrf

                <!-- Header -->
                <div class="bg-gradient-to-r from-purple-600 to-blue-600 px-6 py-4 rounded-t-xl">
                    <h3 class="text-sm font-semibold text-white">Tambah Data Jenis usul_pns</h3>
                </div>

                <!-- Body -->
                <div class="px-6 py-4">
                    <div class="mb-4">
                        <label for="nama" class="block text-sm font-medium text-gray-700 mb-2">Nama Jenis usul pns
                        </label>
                        <input type="text" id="nama" name="nama" placeholder="Masukkan nama jenis usul_pns"
...
<div id="modalEdit" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
    ...
    <div class="flex items-center justify-center min-h-screen p-4 text-center sm:p-0">
        <div class="relative bg-white rounded-xl shadow-xl transform transition-all sm:max-w-md w-full">
            ...
            <!-- Modal Content -->
            <form method="post" action="/usul_pns/jenis_usul_pns/edit" enctype="multipart/form-data">
                @csrf

                <!-- Header -->
                <div class="bg-gradient-to-r from-purple-600 to-blue-600 px-6 py-4 rounded-t-xl">
                    <h3 class="text-sm font-semibold text-white">Edit Data Jenis usul_pns</h3>
                </div>
                ...
                <div class="px-6 py-4">
                    <div class="mb-4">
                        ...
                        <input type="text" id="edit_nama" name="nama" placeholder="Masukkan nama jenis usul_pns"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors">
