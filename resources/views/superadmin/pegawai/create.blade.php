...
<div class="space-y-6">
    ...
    <div class="flex items-center space-x-4">
        ...
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Tambahkan data pegawai baru ke sistem</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-900">Form Data Pegawai</h2>
        </div>

        <form action="{{ route('superadmin.pegawai.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="ket_jabatan" name="ket_jabatan" value="{{ old('ket_jabatan') }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
