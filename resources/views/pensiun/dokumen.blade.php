                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-3 py-2 border border-gray-300">
                                    @if ($dokumen)
                                    <a target="_blank"
                                        href="/storage/pensiun/{{ $data->pegawai->nip }}/pengajuan{{ $id }}/{{ $dokumen->file }}"
                                ...
                                <td class="px-3 py-2 border border-gray-300 text-center">
                                    ...
                                    <div class="flex items-center justify-center gap-1">
                                        <a href="/pensiun/dokumen/{{ $id }}/berkas-ok/{{ $dokumen->id }}"
...
<div id="modal-perbaiki" class="fixed inset-0 z-50 hidden overflow-y-auto" aria-labelledby="modal-title" role="dialog"
    ...
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
            ...
            <form method="post" action="/pensiun/dokumen/{{ $id }}/perbaikidokumen" enctype="multipart/form-data">
                @csrf
