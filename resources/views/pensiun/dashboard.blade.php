...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
  <!-- Pensiun Baru -->
  <a href="/pensiun/baru" class="group">
    <div
      ...
      <div class="flex items-center justify-between">
        <div>
          <p class="text-blue-100 text-xs font-medium mb-0.5">Pensiun Baru</p>
          <h3 class="text-2xl font-bold text-white">{{ $pensiun }}</h3>
          <p class="text-blue-100 text-[10px] mt-1">Total Data Pengajuan Pensiun Baru</p>
        </div>
  ...
  <!-- Pensiun Diproses -->
  <a href="/pensiun/diproses" class="group">
    <div
      ...
      <div class="flex items-center justify-between">
        <div>
          <p class="text-emerald-100 text-xs font-medium mb-0.5">Pensiun Diproses</p>
          <h3 class="text-2xl font-bold text-white">{{ $diproses }}</h3>
          <p class="text-emerald-100 text-[10px] mt-1">Total Data Pensiun Diproses</p>
        </div>
        <div class="bg-white/20 rounded-full p-3 group-hover:bg-white/30 transition-colors">
          <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
  ...
  <!-- Pensiun Selesai -->
  <a href="/pensiun/selesai" class="group">
    <div
      ...
      <div class="flex items-center justify-between">
        <div>
          <p class="text-amber-100 text-xs font-medium mb-0.5">Pensiun Selesai</p>
          <h3 class="text-2xl font-bold text-white">{{ $selesai }}</h3>
          <p class="text-amber-100 text-[10px] mt-1">Total Data Pensiun Selesai</p>
        </div>
        <div class="bg-white/20 rounded-full p-3 group-hover:bg-white/30 transition-colors">
          <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<div class="bg-white rounded-xl shadow-lg overflow-hidden">
  <div class="bg-gradient-to-r from-purple-600 to-blue-600 px-4 py-3">
    <h3 class="text-sm font-semibold text-white">Daftar ASN yang mengajukan pensiun</h3>
  </div>

  <div class="p-6">
    <div class="overflow-x-auto">
      <table id="pensiunTable" class="display" style="width:100%">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          ...
          <tr data-id="{{ $loop->index + 1 }}">
            ...
            <td class="px-4 py-4 text-sm">
              <a href="/pensiun/dokumen/{{ $item->id }}"
            ...
            <td class="px-4 py-4 text-sm">
              ...
              <div class="flex space-x-1">
                ...
                <a href="/pensiun/prosespengajuan/{{ $item->id }}"
                  onclick="return confirm('Yakin Ingin di proses?')"
                ...
                @endif
                <a href="/pensiun/deletepengajuan/{{ $item->id }}" onclick="return confirm('Yakin Ingin Dihapus?')"
                ...
                @if ($item->nama_verifikator != null)
                <a href="/pensiun/selesaipengajuan/{{ $item->id }}" onclick="return confirm('Yakin sudah selesai?')"
                  class="inline-flex items-center px-3 py-1.5 bg-blue-600 text-white text-xs font-medium rounded-md hover:bg-blue-700 transition-colors">
                  <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                  </svg>
