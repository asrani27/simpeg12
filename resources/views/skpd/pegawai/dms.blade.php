...
@section('header_title', 'Dokumen Pegawai')
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Dokumen Kepegawaian</h1>
                <p class="text-sm text-gray-600 mt-1">Upload dan kelola dokumen pegawai: {{ $pegawai->nama }}</p>
            </div>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                @elseif($dmsRecord && $dmsRecord->drh)
                                <a href="{{ route('skpd.pegawai.dms.download', [$pegawai->id, 'drh']) }}"
                                ...
                                @else
                                <form action="{{ route('skpd.pegawai.dms.store', $pegawai->id) }}" method="POST"
                    ...
                    <tr class="bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                <span class="text-sm text-gray-500 italic">Dokumen dari SIASN</span>
                                @elseif($dmsRecord && $dmsRecord->sk_cpns)
                                <a href="{{ route('skpd.pegawai.dms.download', [$pegawai->id, 'sk_cpns']) }}"
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                <span class="text-sm text-gray-500 italic">Dokumen dari SIASN</span>
                                @elseif($dmsRecord && $dmsRecord->d2np)
                                <a href="{{ route('skpd.pegawai.dms.download', [$pegawai->id, 'd2np']) }}"
                    ...
                    <tr class="bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                <span class="text-sm text-gray-500 italic">Dokumen dari SIASN</span>
                                @elseif($dmsRecord && $dmsRecord->spmt)
                                <a href="{{ route('skpd.pegawai.dms.download', [$pegawai->id, 'spmt']) }}"
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                <span class="text-sm text-gray-500 italic">Dokumen dari SIASN</span>
                                @elseif($dmsRecord && $dmsRecord->sk_pns)
                                <a href="{{ route('skpd.pegawai.dms.download', [$pegawai->id, 'sk_pns']) }}"
                                    class="inline-flex items-center px-3 py-1.5 text-xs font-medium text-red-700 bg-red-100 hover:bg-red-200 rounded transition-colors">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path>
