...
<body class="min-h-screen flex items-center justify-center px-4 relative">
    ...
    <div class="bg-white rounded-3xl shadow-2xl overflow-hidden max-w-5xl w-full flex flex-col md:flex-row">
        ...
        <div
            class="md:w-1/2 bg-gradient-to-br from-indigo-600 to-purple-700 p-12 flex flex-col justify-center items-center text-white relative overflow-hidden">
            ...
            <!-- Logo -->
            <div
                class="inline-flex items-center justify-center w-32 h-32 bg-white bg-opacity-20 backdrop-blur-sm rounded-full shadow-lg mb-8 relative z-10 p-4">
            ...
            <div class="space-y-4 relative z-10">
                ...
                <div class="flex items-center space-x-3">
                    <div class="w-2 h-2 bg-white rounded-full"></div>
                    <span class="text-indigo-100">Sistem Layanan Modern</span>
                </div>
                <div class="flex items-center space-x-3">
                    <div class="w-2 h-2 bg-white rounded-full"></div>
        ...
        <div class="md:w-1/2 p-12 flex flex-col justify-center">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button type="button" id="togglePassword"
                            ...
                            <svg id="eyeOffIcon"
                                class="h-5 w-5 text-gray-400 hover:text-gray-600 transition-colors hidden" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a10.05 10.05 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.542 7a10.057 10.057 0 01-2.709 4.514m0 0L21 21">
                                </path>
                            </svg>
                        </button>
                    </div>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-500">
                    Butuh bantuan? <a href="#" class="text-indigo-600 hover:text-indigo-500 font-medium">Hubungi
                        administrator</a>
                </p>
            </div>
        </div>
