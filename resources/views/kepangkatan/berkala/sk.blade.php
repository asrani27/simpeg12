                ...
                <div class="col-lg-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nomor_sk" value="822.3/  -KP/BKD.Diklat">
                            </div>
                            </div>
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="perihal" value="Kenaikan Gaji Berkala A.n. {{ucwords(strtolower($data->nama))}} NIP: {{$data->nip}}">
                            </div>
                            </div>
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="nama" value="{{ucwords(strtolower($data->nama))}}">
                            </div>
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="pangkat" value="{{ucwords(strtolower($data->pangkat))}}">
                            </div>
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="unit_kerja" value="{{ucwords(strtolower($data->unit_kerja))}} Kota Banjarmasin">
                            </div>
                            </div>
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="oleh_pejabat" value="Walikota Banjarmasin">
                            </div>
                            </div>
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="oleh_nomor" value="822.3/  -KP/BKD.Diklat">
                            </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" rows=4 name="deskripsi">Diharapkan agar sesuai dengan Peraturan Pemerintah Nomor 7 Tahun 1977 jo Peraturan Pemerintah Nomor 30 Tahun 2018 dan Keputusan Presiden berikutnya, maka sesuai Anggaran Pendapatan Dan Belanja Daerah tahun yang bersangkutan, kepada Pegawai Negeri tersebut dapat dibayarkan penghasilannya berdasarkan gaji pokok yang baru</textarea>
                            </div>
                            </div>
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nama_kadis" value="{{$ttd->nama}}" required>
                            </div>
                            </div>
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nip_kadis" value="{{konversi_nip($ttd->nip)}}" required>
                            </div>
                            </div>
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="pangkat_kadis" value="{{$ttd->nm_pangkat}}" required>
                            </div>
                            </div>
