...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
  ...
  <a href="/kepangkatan/baru" class="group">
    <div
      ...
      <div class="flex items-center justify-between">
        <div>
          <p class="text-blue-100 text-xs font-medium mb-0.5">Kenaikan Pangkat</p>
          <h3 class="text-2xl font-bold text-white">{{ $pangkat }}</h3>
          <p class="text-blue-100 text-[10px] mt-1">Total Data Pengajuan Kenaikan Pangkat Baru</p>
        </div>
  ...
  <!-- Kenaikan Diproses -->
  <a href="/kepangkatan/diproses" class="group">
    <div
      ...
      <div class="flex items-center justify-between">
        <div>
          <p class="text-emerald-100 text-xs font-medium mb-0.5">Kenaikan Diproses</p>
          <h3 class="text-2xl font-bold text-white">{{ $diproses }}</h3>
          <p class="text-emerald-100 text-[10px] mt-1">Total Data Kenaikan Pangkat Diproses</p>
        </div>
        <div class="bg-white/20 rounded-full p-3 group-hover:bg-white/30 transition-colors">
          <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
  ...
  <!-- Kenaikan Selesai -->
  <a href="/kepangkatan/selesai" class="group">
    <div
      ...
      <div class="flex items-center justify-between">
        <div>
          <p class="text-amber-100 text-xs font-medium mb-0.5">Kenaikan Selesai</p>
          <h3 class="text-2xl font-bold text-white">{{ $selesai }}</h3>
          <p class="text-amber-100 text-[10px] mt-1">Total Data Kenaikan Pangkat Selesai</p>
        </div>
        <div class="bg-white/20 rounded-full p-3 group-hover:bg-white/30 transition-colors">
          <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<div class="bg-white rounded-xl shadow-lg overflow-hidden">
  <div class="bg-gradient-to-r from-purple-600 to-blue-600 px-4 py-3">
    <h3 class="text-sm font-semibold text-white">Daftar ASN yang mengajukan kenaikan pangkat</h3>
  </div>

  <div class="p-6">
    <div class="overflow-x-auto">
      <table id="kepangkatanTable" class="display" style="width:100%">
          ...
          <tr data-id="{{ $loop->index + 1 }}">
            ...
            <td class="px-4 py-4 text-sm">
              ...
              <div class="flex space-x-1">
                ...
                <a href="/kepangkatan/prosespengajuan/{{ $item->id }}"
...
<script>
  $(document).ready(function() {
    var table = $('#kepangkatanTable').DataTable({
      responsive: true,
      pageLength: 10,
